...
namespace PlemionaApplication.Migrations
{
    ...
    [Migration("20240905222155_ResistanceNerf")]
    partial class ResistanceNerf
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniProjekt.Armory", b =>
                {
                    b.HasOne("MiniProjekt.Expedition", "Expedition")
                        .WithMany()
            ...
            modelBuilder.Entity("MiniProjekt.DefensiveWalls", b =>
                {
                    b.HasOne("MiniProjekt.Expedition", "Expedition")
                        .WithOne("DefensiveWalls")
                        .HasForeignKey("MiniProjekt.DefensiveWalls", "ExpeditionId");
